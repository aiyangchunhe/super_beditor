...
# from configure import get_be2dpam
import logging
...
#                     logging.warning(f"BEs[{method}][0]!=codon[{posi}]")
    ...
    if len(dmutagenesis)==0:
        from lib.global_vars import saveemptytable
...
#         print(dmutagenesis.shape)
        ...
        from lib.io_seqs import reverse_complement_multintseq
...
# from lib.io_dfs import df2unstack
...
def dseq2dmutagenesis(cfg):
    # from lib.global_vars import BEs2mutations,pos_muts
    """
    ...
    if not exists(dmutagenesisp) or cfg['force']:
        ...
        from lib.global_vars import cols_dbes
